...
$esteTrabajador=(new Trabajadores)->read($id);
...
<body style="background-color:#1ABC9C">
    <h5 class="text-center mt-2">Actualizar Trabajador</h5>
    <div class="container mt-2">
        <div class="my-2 p-4 mx-auto bg-secondary text-white" style=" width:40rem">
            <form name="ctrabajador" method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=$id"; ?>">
                <div class="mb-3">
                    <label for="n" class="form-label">Nombre:</label>
                    <input type="text" class="form-control" id="t" value="<?php echo $esteTrabajador->nombre; ?>" name="nombre" >
                    <?php
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="a" value="<?php echo $esteTrabajador->apellidos; ?>" name="apellidos" >
                    <?php
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="s" value="<?php echo $esteTrabajador->telefono; ?>" name="telefono"></input>
                    <?php
